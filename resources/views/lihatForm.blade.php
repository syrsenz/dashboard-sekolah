...
{{-- Fasilitas Section --}}
<br><br><br> <!--Br e aja dihapus soal e ketumpuk header -->

    <div class="alert alert-success text-center" role="alert">
        Selamat Anda Sudah Terdaftar Di sistem. Berikut Data Anda <br>
        Silahkan Download Formulir Dengan Cara menekan Tombol 'Download Yang Terdapat Di Bawah Form Sebagai Bukti Pendaftaran'
    </div>
                        ...
                        <table border="0" width="100%">
                            <tr>
                                ...
                                <td rowspan="6" align="center">
                                    <img src="/assets/template-foto-form.jpg" width="113px" height="151px">
                                </td>
                            </tr>
                            <tr>
...
<div class="d-flex justify-content-center p-3">
    <a class="btn btn-success m-3" href="/download-form/{{$s->id}}">Download Formulir</a>
</div>
